...
doSession('5-all-t1000-4', { MaxN, MaxNIS, Hypermax, Paranoid }, 'time', 1000);
...
doSession('5-max-para-t1000-3', { MaxNIS, Paranoid }, 'time', 1000);
doSession('5-max-para-t1000-4', { MaxNIS, Paranoid }, 'time', 1000);

doSession('5-hyper-para-t1000', { Hypermax, Paranoid }, 'time', 1000);
doSession('5-hyper-para-t1000-2', { Hypermax, Paranoid }, 'time', 1000);
doSession('5-hyper-para-t1000-3', { Hypermax, Paranoid }, 'time', 1000);
doSession('5-hyper-para-t1000-4', { Hypermax, Paranoid }, 'time', 1000);