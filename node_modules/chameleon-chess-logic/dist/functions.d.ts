 ...
 */
export declare function getBoard(): TBoard;
/**
 ...
 */
export declare function beginGame(red: boolean, green: boolean, yellow: boolean, blue: boolean): IGameState | null;
/**
 ...
 */
export declare function getIndexOfPawnAtPosition(gameState: IGameState, position: IPosition): number;
/**
 ...
 */
export declare function getMoves(gameState: IGameState, pawnsIndex: number): IPosition[];
/**
 ...
 */
export declare function makeMove(gameState: IGameState, pawnsIndex: number, destination: IPosition): IGameState | null;
/**
 ...
 */
export declare function makeComputerMove(gameState: IGameState): Promise<IGameState>;
/**
 * Returns true if the given game is already over, false if not.
 * @param gameState the current game state
 * @returns true if the given game is already over, false if not
 */
export declare function isGameOver(gameState: IGameState): boolean;
/**
 ...
 */
export declare function isGameState(gameState: any): gameState is IGameState;
/**
 ...
 */
export declare function isPlayersAlive(gameState: IGameState): {
